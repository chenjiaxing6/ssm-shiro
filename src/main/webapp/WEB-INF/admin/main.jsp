...
<div class="container">
    <div class="logo">
        <a href="/admin/system/main">后台管理</a></div>
    <div class="left_open">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child">
                ...
                <dd>
                    <a href="/admin/user/logout">退出</a></dd>
            </dl>
        </li>
    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('管理员列表','/admin/system/admin_list')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>管理员列表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('角色管理','/admin/system/role_list')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>角色管理</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('权限管理','/admin/system/permission_list')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>权限列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                <a href="javascript:;" onclick="xadmin.add_tab('权限管理','/admin/system/permission_list')">
                    <i class="iconfont left-nav-li" lay-tips="开发文档">&#xe6b4;</i>
                    <cite>开发中</cite>
                </a>
            </li>
        </ul>
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='/admin/system/welcome' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
        </div>
        <div id="tab_show"></div>
    </div>
